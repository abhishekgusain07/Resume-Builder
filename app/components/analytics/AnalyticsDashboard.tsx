...
const AnalyticsDashboard = ({
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="grid w-full mx-auto grid-cols-1 gap-6 md:grid-cols-2">
      ...
      <Card className="flex flex-col sm:grid grid-cols-4 gap-6">
        <h2 className="w-full text-dark-tremor-content-strong  text-center sm:text-left font-semibold text-xl">This Week Top Visitors:</h2>
        <div className="col-span-3 flex items-center justify-between flex-wrap gap-8">
            {
                topCountries?.map(([countryCode, number]) => {
                    return <div key={countryCode} className="flex items-center gap-3 text-dark-tremor-content-strong">
                        ...
                        <p className="text-tremor-content sm:text-tremor-content-strong">{number}</p>
                    </div>
                })
            }
        </div>
